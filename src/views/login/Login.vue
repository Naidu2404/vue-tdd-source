import { pushScopeId } from 'vue'; import { pushScopeId } from 'vue'; import { pushScopeId } from
'vue'; import { router } from 'test'; import { useRouter } from 'vue-router'; import { useRoute }
from 'vue-router'; import { useRouter } from 'vue-router'; import { RouterLink } from 'vue-router';
<template>
    ...
    <form @submit.prevent="submit">
      <Card>
        ...
        <template v-slot:footer>
          <RouterLink to="/password-reset/request">{{ $t('passwordReset.forgot') }}</RouterLink>
        </template>
      </Card>
    </form>
  </div>
